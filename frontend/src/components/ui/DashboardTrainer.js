...
const DashboardTrainer = () => {
  ...
  return (
    <div className="content-area mt-20">
      <div className="dashboard-container">
        <div className="welcome-banner trainer">
        ...
        <div className="tab-content mt-6">
          {activeTab === 'overview' && (
            <div className="announcement-box p-6 bg-white rounded-lg shadow-md">
              ...
              <p className="mb-4">For any assistance or inquiries regarding your training activities on our platform, please use the contact information below to reach our admin team.</p>
