...
const DashboardJobSeeker = () => {
  ...
  return (
    <div className="content-area mt-20 l:mt-5">
      <div className="dashboard-container">
        <div className="welcome-banner">
          <div className="welcome-text">
            <h1>Welcome, <span className="text-blue-600 font-bold">{user?.name || 'Job Seeker'}</span>!</h1>
        ...
        <div className="tab-content mt-6">
          {activeTab === 'overview' && (
            <div className="announcement-box p-6 bg-white rounded-lg shadow-md">
              ...
              <p className="mb-4">For any assistance or inquiries regarding your job search on our platform, please use the contact information below to reach our admin team.</p>
